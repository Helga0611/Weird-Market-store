...
export default async function StorePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="store-page">
      ...
      <section className="store-toolbar"><div><span>✦</span><p><b>Chủ tiệm đang online</b>Trả lời trong khoảng 3 nhịp đũa</p></div><button>Theo dõi gian hàng</button></section>
